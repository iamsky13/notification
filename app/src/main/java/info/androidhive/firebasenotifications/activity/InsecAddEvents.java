 ...
 */
public class InsecAddEvents extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.insec_add_events);
        webView = (WebView) findViewById(R.id.webViewAddevents);
        progressBar = (ProgressBar) findViewById(R.id.progressBarAddevents);
        progressBar.getIndeterminateDrawable().setColorFilter(Color.RED, PorterDuff.Mode.MULTIPLY);
        layoutProgress = (LinearLayout) findViewById(R.id.layoutProgressAddevents);
 ...
 */
        ...
        if(isOnline()) {
            webView.loadUrl("http://insecnotification.azurewebsites.net");
        } else {
